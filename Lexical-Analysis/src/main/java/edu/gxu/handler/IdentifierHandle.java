...
public class IdentifierHandle implements LexicalHandle{
    Text text;
    ...
    public Token getToken() {
        return new Token(matches.toString(), TokenType.Keyword.getType(), CategoryCodeEnum.Identifier.getCode(), text.getLineNumber());
    }
